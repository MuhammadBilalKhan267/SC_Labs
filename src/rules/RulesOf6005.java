...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // If the code is written by yourself, you can always use it
	    if (writtenByYourself) {
	        return true;
	    }
	    
	    // If it's written as course work, you can use it
	    if (writtenAsCourseWork) {
	        return true;
	    }
	    
	    // If citing is required but you are not citing your source, return false
	    if (!citingYourSource) {
	        return false;
	    }
	    
	    // If implementation is required and you're not writing the code yourself, return false
	    if (implementationRequired && !writtenByYourself) {
	        return false;
	    }

	    // If the code is available to others and you are citing the source, it might be allowed
